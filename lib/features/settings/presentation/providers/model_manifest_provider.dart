...
export '../../../../core/services/llama_service_provider.dart' show modelDownloadServiceProvider;
...
class ModelDownloadNotifier extends StateNotifier<ModelDownloadState> {
  ...
  ModelDownloadNotifier(this._service, this._ref) : super(const ModelDownloadState());
